...
if ChouseTask==1:
    YourTask=Fore.BLUE+'Охолодження'
    EnemyTaks=Fore.RED+'Підсмаження'
elif ChouseTask==2:
    YourTask=Fore.RED+'Підсмаження'
    EnemyTaks=Fore.BLUE+'Охолодження'
else:
    print("Неправильно введені дані. Ваша шкода - "+Fore.BLUE+'Охолодження')
    YourTask=Fore.BLUE+'Охолодження'
    EnemyTaks=Fore.RED+'Підсмаження'
...
if EnemyTaks==Fore.RED+'Підсмаження':
    EnemyDamage=random.randint(32,1000)
else: 
    EnemyDamage=random.randint(32,1000) 
print("")
if YourDamage>0 and YourTask==Fore.BLUE+'Охолодження':
...
elif EnemyDamage>0 and EnemyTaks==Fore.BLUE+'Охолодження':
...
elif YourDamage<0 and YourTask==Fore.BLUE+'Охолодження':
    print(f"Суперник наніс вам : "+f"\033[31m{EnemyDamage}\033[0m".format() +" фарангейт або " f"\033[31m{FahrenheitToCelsius(EnemyDamage)}\033[0m".format() +"  целсій")
    print("Ви нанесли ворогу: "+f"\033[34m{YourDamage}\033[0m".format() +" цельсій або " +f"\033[34m{CelsiusToFahrenheit(YourDamage)}\033[0m".format() +" фаренгейт") 
    YourDamage=-YourDamage
