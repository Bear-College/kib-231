...
def GladiatorBattle(HealthGladiator1,HealthGladiator2):
    ...
    print(f"\nGladiator 1: {HealthGladiator1} health , {DamageGladiator1} damage , {ArmorGladiator1} armor ")
    ...
    return HealthGladiator1,HealthGladiator2

HpGladiator1=int(input("введіть здоров'я гладіатора 1.."))
HpGladiator2=int(input("введіть здоров'я гладіатора 2.."))
GladiatorBattle(HpGladiator1,HpGladiator2)